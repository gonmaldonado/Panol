<%@ Page Title="Entrada" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Entrada.aspx.cs" Inherits="Pañol.Entrada" %>
...
<form action="">
  <div class="form-group">
     <div class="row">
        <div class="col-md-6">
            <h1><span class="label label-default">Entrada</span></h1>
            <table style="width: 100%;">
                <tr>
                    <td style="height: 22px; width: 95px"><asp:Label ID="Label1" runat="server" Text="Articulo:"></asp:Label><br />
            ...
            <table>
                <tr>
                    <td style="height: 22px; width: 95px"><asp:Label ID="Label2" runat="server" Text="Cantidad:"></asp:Label><br />
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnagregar" runat="server" Text="Agregar"  cssclass="btn btn-success btn-s" OnClick="btnagregar_Click"/>
            ...
            <table>
                <tr>
                    <td style="height: 22px; width: 95px"><asp:Label ID="Label3" runat="server" Text="Nota de entrega:"></asp:Label><br />
                        <asp:TextBox ID="txtDocumento" runat="server" Height="27px" Width="352px" ></asp:TextBox>
                    </td>    
                </tr>
            </table>
            <br />
         <asp:Button ID="btnEntrada" runat="server" Text="Confirmar Entrada " cssclass="btn btn-success btn-lg" OnClick="btnEntrada_Click" />
         <a href="Default.aspx" class="btn btn-secondary btn-lg">Cancelar </a>
      
  </div>
  <div class="col-md-6">
       <asp:Panel ID="Panel1" runat="server">
                      <asp:GridView ID="gvItems" runat="server" Caption="Lista de articulos ingresados:"  CssClass="table table-striped table-hover table-condensed small-top-margin" AutoGenerateDeleteButton="True" OnRowDeleted="gvItems_RowDeleted" OnRowDeleting="gvItems_RowDeleting" OnSelectedIndexChanged="gvItems_SelectedIndexChanged"></asp:GridView>
        </asp:Panel>
