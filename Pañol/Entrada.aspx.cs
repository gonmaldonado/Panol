...
namespace Pañol
{
    public partial class Entrada : Utilidades
    {
        ...
        protected void btnEntrada_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (!Logica.Registro.ValidarDocEntrega(txtDocumento.Text.Trim()))
                    {
                        ...
                        Reg.Documento = txtDocumento.Text.ToUpper().Trim();
                    ...
                    {
                        MsgBox("La nota de entrega: "+txtDocumento.Text.Trim().ToUpper()+" ya se encuentra asociada a un ingreso");
                    }

                }
                else
                {
                    MsgBox("No se puede registrar le entrada de mercaderia sin nota de entrega asociada");
